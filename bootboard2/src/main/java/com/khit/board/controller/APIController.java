...
public class APIController {
	...
	public @ResponseBody String getData() {
		try {
			...
			String url = "https://apis.data.go.kr/1741000/TsunamiShelter3/getTsunamiShelter1List?serviceKey=zsy2cxIsnAul6JnzOV1ul3h%2FKXxNtT7Xw7Q6BOieVjRXmFxmTjKs1S02jYe6mE8sRHEQ38e8sfupjwYKLKImsQ%3D%3D&pageNo=1&numOfRows=10&type=json";
			...
			return responseText; // json 형태로 반환
